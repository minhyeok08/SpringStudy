...
<body>
	<div class="container-fluid">
		<div class="row">
		 <div class="col-sm-8">
			<div class="col-md-3" v-for="vo in rentcar_list">
				<div class="thumbnail">
				      <a href="/w3images/lights.jpg">
				        <img :src="vo.img" alt="Lights" style="width:100%">
					        <div class="caption">
					        <p style="font-size:9px">{{vo.car_name}}&nbsp;<span style="color:orange">{{vo.price}}</span></p>
					        </div>		
      				  </a>
    			</div>
    		</div>
	...
	<script>
		new Vue({
			...
			methods:{
				send:function(){
					axios.get("http://localhost/web/rentcar/list_vue.do",{
						params:{
							page:this.curpage
						}
					}).then(response=>{
						console.log(response.data)
						this.rentcar_list=response.data;
