	...
	<script>
		new Vue({
			...
			beforeMount:function(){
				console.log("beforeMount:가상 메모리(가상돔)에 올리기 전...")
			},
			mounted:function(){
