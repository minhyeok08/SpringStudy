...
<script type="text/javascript" src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=c6461032bfd9331ad3ba2ccc5ffbead2&libraries=services"></script>
<style type="text/css">
.container{
	margin-top:50px;
}
		...
		new Vue({
			...
			methods:{
				...
				addScript:function(){
					...
					/* global kakao */
					script.onload=()=>kakao.map.load(this.initmap)
					script.src='https://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=c6461032bfd9331ad3ba2ccc5ffbead2&libraries=services'
