...
public class DataBoardController {
   ...
   public void databoardDownload(String fn,HttpServletResponse response)
   {
	   try
	   {
		   ...
		   while((i=bis.read(buffer,0,1024))!=-1) // -1 : EndOfFile 파일이 끝나기전까지
		   {
   ...
   @ResponseBody // 승격 (@RestController) // 원하는 데이터를 보낸다 대체적으로 script
   public String databard_update_ok(DataBoardVO vo)
   {
	   String result="";
	   // dao 연동
