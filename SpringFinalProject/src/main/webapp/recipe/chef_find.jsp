	...
	<table class="table">
		...
		<tr>
			<td class="text-center">
				<img src="../recipe/image/mem1.PNG">&nbsp;{{chef_info.mem_cont1}}
			</td>
			<td class="text-center">
				<img src="../recipe/image/mem2.PNG">&nbsp;{{chef_info.mem_cont2}}
			</td>
			<td class="text-center">
				<img src="../recipe/image/mem7.PNG">&nbsp;{{chef_info.mem_cont4}}
			</td>
			<td class="text-center">
				<img src="../recipe/image/mem3.PNG">&nbsp;{{chef_info.mem_cont3}}
			</td>
		</tr>
	</table>
	<%--
			...
			2. template : 컴포넌트 (기능) => 화면에 출력할 요소(태그를) 작성
				Vue.component('태그명',
      ...
      <div id="gallery">
        <figure>
          ...
          <ul class="nospace clear">
            ...
            :class="index%4==0?'one_quarter first':'one_quarter'">
            <a href="#">
          ...
          <!-- <ul class="nospace clear">
            <li v-else="vo,index in recipe_list" 
            :class="index%4==0?'one_quarter first':'one_quarter'">
            <a href="#">
            <img :src="vo.poster" :title="vo.title+'('+vo.chef+')'">
            </a>
