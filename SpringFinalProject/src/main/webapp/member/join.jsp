     ...
     new Vue({
        ...
        methods:{
           ...
           idCheckValidate:function(id){
              ...
              let num=id_res.search(/[0-9]/g) // 없으면 -1 반환
              let eng=id_res.search(/[a-z]/ig) // 없으면 -1 반환
           ...
           emailValidate:function(){
              ...
              {
                 // test() => 정규식을 비교할 때 사용
                 this.emailOk="이메일 형식이 올바르지 않습니다."
              }
              else
              {
                 this.emailOk=''
